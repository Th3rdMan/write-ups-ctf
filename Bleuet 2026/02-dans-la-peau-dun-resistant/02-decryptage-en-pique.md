...
![2. Décryptage en piqué](./assets/2-decryptage-en-pique.png)
...
En cherchant un peu, je confirme qu'il s'agit bien du pont National, un pont tournant en métal de Brest. Une innovation de l'époque (1861), mais qui a été détruit soit par les bombardements alliés, soit par les allemands pour freiner la progression des américains, selon les sources. Mais on est donc bien à **Brest**, pendant les bombardements alliés, en **1944**.
