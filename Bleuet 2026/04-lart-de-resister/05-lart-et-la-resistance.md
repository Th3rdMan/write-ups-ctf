# L'art et la resistance

![5. L'art et la résistance](./assets/5-lart-et-la-resistance.png)
...
![5. Peinture](./assets/5-peinture.png)

---

Je commence par une recherche d'image inversée pour identifier le tableau. Il s'agit d'une peinture d'**Henri Fantin-Latour** de 1872, intitulé "**Un coin de table**".
