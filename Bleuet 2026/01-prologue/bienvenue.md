...
![Bienvenue](./assets/bienvenue.png)
...
Afin d'avoir accès aux différents documents, veuillez lire le règlement de ce CTF et trouver dans ce dernier sous combien de jours, les vainqueurs tirés au sort de ce CTF seront contactés.
...
![Bienvenue - Réponse](./assets/bienvenue-reponse.png)
